...
Architecture **OpenRouter BYOK** (Bring Your Own Key) — une seule clé pour accéder à **tous les modèles** supportés par OpenRouter (360+, dont GPT-4o, Claude, Gemini, Llama, ...).
